...
RUN curl -L https://github.com/owenthereal/upterm/releases/download/v${UPTERM_VERSION}/upterm_linux_amd64.tar.gz | tar --directory /usr/local/bin --extract --ungzip
# gopls binary
